...
| Component | Target Metric | Performance Output |
|---|---|---|
| **TFT Model** | Multi-Horizon Quantile Loss (`P50`) | `< 4.2%` WAPE |
| **RL Dispatch Agent** | Arbitrage Yield Improvement | `+18.4%` vs Rule Baseline |
| **API Latency** | Inference Response Speed | `< 45 ms` / request |
